...
public class NOVA_Part_DoubleRopeSlide : NOVA_Part
{
	protected override void Awake()
	{
		base.Awake ();
		PartID = NOVA_PartID.Part_RopeSlide_Double;
	}
	...
	protected override IEnumerator SetStartMaterial ()
	{
		...
		Material[] mats = new Material[3]{ColorManager.SecondaryMat, ColorManager.PrimaryMat, rendComp.materials[2] };
