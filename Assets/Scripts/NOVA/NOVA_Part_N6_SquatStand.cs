...
public class NOVA_Part_N6_SquatStand : NOVA_Part
{
	protected override void Awake()
	{
		base.Awake ();
		PartID = NOVA_PartID.Part_SquatStand;
	}
	...
	{		
		gameObject.name = "SQUAT STAND " + myNumber.ToString();
	}
	...
	protected override IEnumerator SetStartMaterial ()
	{
		...
		// materials[2] is the oly bar, silver and never changes
		// materials[3] is the oly plates, black and never changes
		Material[] mats = new Material[4]{ColorManager.PrimaryMat, ColorManager.SecondaryMat, rendComp.materials[2], rendComp.materials[3] };
	...
	public override void ShowHighlightMaterialsMeOnly ()
	{
		...
		// materials[2] is the oly bar, silver and never changes
		// materials[3] is the oly plates, black and never changes
		Material[] mats = new Material[4]{ColorManager.HighlightMat, ColorManager.HighlightMat, rendComp.materials[2], rendComp.materials[3] };
		rendComp.materials = mats;
	}
